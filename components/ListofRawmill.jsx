...
export default function ListofRawmill() {
  //#region
  ...
  const [resulttotal_C16, setResulttotal_C16] = useState(0);
  const [resulttotal_C17, setResulttotal_C17] = useState(0);
  const [resulttotal_C18, setResulttotal_C18] = useState(0);
  const [resulttotal_C19, setResulttotal_C19] = useState(0);
  ...
  return (
    <ScrollView keyboardShouldPersistTaps="handled">
      <View style={styles.page}>
        <View style={{ width: "50%" }}>
          <Text style={styles.table_head}>RAW MILL 1 List</Text>
        </View>
        ...
        <View style={{ width: "50%" }}>
          <Text style={styles.table_head}>RAW MIX D</Text>
        </View>
